...
class Menu implements KeyListener {
	...
	public Menu(Game game) {
		...
		this.buttons.add(new Button(30, 180, "New game", MenuCommand.NEW_GAME, game.frame.graphics));
		...
		this.buttons.add(new Button(30, 260, "Exit", MenuCommand.EXIT, game.frame.graphics));
